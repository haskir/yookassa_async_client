...
from ..components import Amount, Confirmation, Deal, PaymentMethod, Receipt, RecipientOnCreate, Transfer
from ..validators import check_transfers

__all__ = ["Receiver", "CreatePayment"]
...
class CreatePayment(_CreatePaymentRequired):
    ...
    - вы компания или ИП, для оплаты с соблюдением требований 54-ФЗ используете стороннюю онлайн-кассу и
     отправляете данные для чеков по одному из сценариев: Платеж и чек одновременно или Сначала чек, потом платеж
