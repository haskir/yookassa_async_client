...
from ..components import Amount, Deal, Receipt, Transfer

__all__ = ["CapturePayment"]
...
class CapturePayment(BaseModel):
    ...
    Если вы не подтвердите платеж в отведенное время,
    он автоматически перейдет в статус canceled, и деньги вернутся пользователю.
